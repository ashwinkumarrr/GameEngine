...
struct BoundingBox {
	...
	inline bool Intersects(BoundingBox* box_)
	{
		...
		//Update bounding box
		return (otherMaxCorner.x > otherMinCorner.x &&
			    otherMinCorner.x < otherMaxCorner.x &&
			    otherMaxCorner.y > otherMinCorner.y &&
			    otherMinCorner.y < otherMaxCorner.y &&
			    otherMaxCorner.z > otherMinCorner.z &&
			    otherMinCorner.z < otherMaxCorner.z);
	}
